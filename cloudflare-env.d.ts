/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 5206449d4d1d37aae6cb835eae695612)
// Runtime types generated with workerd@1.20251125.0 2024-12-02 enable_weak_ref,expose_global_message_channel,global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./.open-next/worker");
	}
	interface Env {
		PAYLOAD_PUBLIC_SERVER_URL: "https://login.hivconnectcentralnj.com";
